...
if __name__ == '__main__':
    ...
    def imageur():
        CLIENT_ID = "c06958826c462b4"
        PATH = 'renderizada.jpg'
        im = pyimgur.Imgur(CLIENT_ID)
        uploaded_image = im.upload_image(PATH, title="DEEP FAKE | Pyimageupload")
        link = uploaded_image.link
        #print(uploaded_image.title) #print(uploaded_image.link) #print(uploaded_image.size) #print(uploaded_image.type)
        link_final = f"<a href=\"{link}\"><font color=black>Click to Share!</font></a>"
        label_link.setText(link_final)
